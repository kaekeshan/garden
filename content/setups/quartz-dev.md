...
description: Install Docker app locally - Docker file download and start the docker engine.
draft: false
date: 2025-12-16
...
```
>[!info] the dot represents current directory and it can be replaced with [[linux/administration#module-01---files-and-directories|absolute or relative paths]].
...
>[!info] For more docker commands, refer [[../code/commands#docker-command-line-interface|docker CLI toolkit]]
