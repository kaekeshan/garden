    ...
    Control access to files with ACLs
        ...
        - command
            ...
            - setfacl examples
                ...
                - setfacl -m u::rws, g:consultants:rX, o::- file
        ...
        - theory
            ...
            - managing swap space
                ...
                - combined system ram + swap space = virtual memory
                    - if memory usage > limit 
                    kernel.search(RAM) // kernel looks in the idle memory pages assigned to process in ram.
                    ...
                    if program→request_access_to_page_on disk
                    kernal.write(idle_pages, swap_area) then recalls the needed page from the swap area.
    ...
    Managing Logical Volumes
        ...
        - commands
            - creating a logical volume
                - prepare the device
                **parted -s /dev/vdb mkpart primary 1mib 269mib
            ...
            - extending a volume group
                ...
                **parted -s /dev/vdb mkpart primary 1027 mib 1539 mib**
            ...
            - extending a logical volume and swap space
                ...
                **lvextend -l +extents /dev/vgname/lvname**
                - formate the logical  volume as swap space
