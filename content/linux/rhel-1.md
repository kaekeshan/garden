...
description: Red Hat Enterprise Linux part 1 — accessing the command line, working with files and the filesystem hierarchy, hard and soft links, and shell pattern matching.
draft: false
date: 2025-12-02
tags: [linux, dev]
---
...
![Diagram showing pipeline redirection between commands](../assets/red-hat/pipeline-redirect-diagram.png)

3. **Editing using [[../setups/neo-vim| vim ]]**
...
1. **Permissions**
    ...
    - format
             - ls -l <file>
             ![Format of `ls -l` permission string with type and rwx triplets](../assets/red-hat/ls-l-permission-format.png)
             - '-' for file types
             - 'd' for directory
...
4. **Locating files on the system**
