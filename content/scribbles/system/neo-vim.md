		...
		- configuration
		  ...
		  function SPEC.config()
		    ...
		    require("nvim-treesitter.configs").setup {
		      ensure_installed = { "lua", "markdown", "markdown_inline", "bash", "python", "c", "cpp", "rust" , "java", "javascript", "html", "css", "csv"},
	...
	- None-ls
	  ...
	  collapsed:: true
		...
		- configurations
		  ...
		  return SPEC
		  ```
		  The formatters can be installed via :Mason
	- logseq.order-list-type:: number
	- logseq.order-list-type:: number
- ### References
	- 1. [Ultimate Neovim Config | 2024 | Launch.nvim - YouTube](https://www.youtube.com/watch?v=KGJV0n70Mxs)
