...
![HTML select with a disabled option](../assets/html/disabled-select-option.png)
...
![CSS specificity — later rule wins when selectors are equally specific](../assets/html/css-specificity-priority.png)
